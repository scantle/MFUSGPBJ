...
#' @export calc_stream_voronoi_weights_vec
#'
#' @examples
#' #-- Read in shapefiles
...
#'                                          addTo = swdf)
calc_stream_voronoi_weights_vec <- function(stream, voronoi, triangles, addTo=NULL, geometry=T,
                                        correct_seg_order=T,
  ...
  bary_coords <- geo_to_barycentric_coords_vec(segments = tri_stream, seg_triangles = seg_triangles)
